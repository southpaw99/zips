...
class movies:
    def __init__(self):
        ...
        self.theaters_link = 'https://www.imdb.com/search/title?title_type=feature&num_votes=1000,&countries=us&languages=en&sort=release_date,desc&count=40&start=1'
    ...
    def movieDirectory(self, items):
        ...
        for i in items:
            try:
                ...
                cm.append(('Venom Settings', 'RunPlugin(%s?action=openSettings&query=(0,0))' % sysaddon))
